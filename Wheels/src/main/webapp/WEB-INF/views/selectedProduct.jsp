...
Enter Name/Email ID: <input type="text"  ng-model="search">&nbsp&nbsp<span class="glyphicon glyphicon-search"></span>
    ...
    <th>DESCRIPTION</th>
             ...
             <td>${listOfProducts.id}</td>
            <td>${listOfProducts.name}</td>
            <td>${listOfProducts.description}</td>
            <td>${listOfProducts.category}</td>
            <td>${listOfProducts.price}</td>
             <td><img src="resources/images/${listOfProducts.id}.jpg" style="width: 200px;height:150px"></td>
            <td><a href="addToCart">AddToCart</a></td>
        </tr>    
    </table>
</div>
<script>
